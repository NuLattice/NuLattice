...
@njit
def create_occupations(n_states, ref_indices):
    """
...
def compute_normal_ordered_hamiltonian_no2b(occs: np.ndarray, op1: OneBodyOperator | np.ndarray, op2: TwoBodyOperator, op3: Optional[ThreeBodyOperator]=None):
    """
